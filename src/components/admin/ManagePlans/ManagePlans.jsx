  ...
  return (
    <section className='container mx-auto'>
        <div className='plan-btns flex items-center justify-center text-center py-5'>
            <a className="select-btn caps w-32" href="#">Mobile</a>
            <a className="select-btn caps w-32" href="#">DTH</a>
            <a className="select-btn caps w-32" href="#">Postpaid</a>
            <a className="select-btn caps w-32" href="#">Electricity</a>
        </div>
